...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [CORNER_LAYER] = LAYOUT_planck_grid_wrapper(
    _______, _______, __________MEDIA__________, KC_DEL,  _________________CORNER_L1_________________, _______,
    _______, _______, __________VOLUME_________, KC_BSPC, _________________CORNER_L1_________________, _______,
    _______, _______________STITCH_SWITCH_______________, _________________CORNER_L3_________________, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
