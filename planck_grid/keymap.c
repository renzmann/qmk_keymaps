...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Numeric layer
   * Don't use shift to activate the special characters. This keeps the left thumb
   * free to surround each special character with spaces.
   *
   * "b" is left blank for the C-b tmux prefix when switching to specific window numbers
   *                 ┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
   *                 │  {  │  !  │  @  │  #  │  $  │  %  │  ^  │  &  │  *  │  _  │  =  │  }  │
   *                 ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
   *                 │     │  1  │  2  │  3  │  4  │  5  │  6  │  7  │  8  │  9  │  0  │     │
  ...
  [NUM_LAYER] = LAYOUT_planck_grid_wrapper(
    KC_LCBR, _________________NUMUP_L___________________, _________________NUMUP_R___________________, KC_RCBR,
  ...
  [CORNER_LAYER] = LAYOUT_planck_grid_wrapper(
    ...
    _______, _______, _______, _______, _______, _______, ADJUST,  _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
  ),
