...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY_LAYER] = LAYOUT_planck_grid_wrapper(
    A_TAB,   _________________QWERTY_L1_________________, _________________QWERTY_R1_________________,  A_QT,
    ...
    CORNER,   XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, SFT_SPC,  NUM_SPC, KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT
  ),
  ...
  [NUM_LAYER] = LAYOUT_planck_grid_wrapper(
    ...
    KC_LBRC, _________________TROUGH_L__________________, _________________TROUGH_R__________________, KC_RBRC,
